...
public class MediaCodecDecoderRendererVR extends VideoDecoderRenderer {
    ...
    public MediaCodecDecoderRendererVR(PreferenceConfiguration prefs,
    ...
    static class RendererException extends RuntimeException {
        ...
        RendererException(MediaCodecDecoderRendererVR renderer, Exception e) {
            this.text = generateText(renderer, e, null, 0);
        }

        RendererException(MediaCodecDecoderRendererVR renderer, Exception e, ByteBuffer currentBuffer, int currentCodecFlags) {
        ...
        private String generateText(MediaCodecDecoderRendererVR renderer, Exception originalException, ByteBuffer currentBuffer, int currentCodecFlags) {
            String str = "";
